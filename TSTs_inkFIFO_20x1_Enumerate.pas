unit TSTs_inkFIFO_20x1_Enumerate;
...
type
 ...
 tTests_inkFIFO_20x1_Enumerate= class(tTSTCTC_CORE_inkFIFO)
  protected
...
procedure tTests_inkFIFO_20x1_Enumerate._enumData_CLR(const DATA:pointer);
begin
    with pTests_EnumDATA(DATA)^ do begin
      owner  :=SELF;
      counter:=0;
...
procedure tTests_inkFIFO_20x1_Enumerate.Enumerate_Nil;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkFIFO_20x1_Enumerate.Enumerate_One;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkFIFO_20x1_Enumerate.Enumerate_Two;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
procedure tTests_inkFIFO_20x1_Enumerate.Enumerate_SiX;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
...
initialization
    RegisterTest(cTestSuitePath__inkFIFO,tTests_inkFIFO_20x1_Enumerate);
end.
