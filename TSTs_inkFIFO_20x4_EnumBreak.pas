unit TSTs_inkFIFO_20x4_EnumBreak;
...
type
 ...
 tTests_inkFIFO_20x4_EnumBreak= class(tTSTCTC_CORE_inkFIFO)
  protected
...
function tTests_inkFIFO_20x4_EnumBreak._Enum_FNK_(const Data:pointer; const NODE:pointer):boolean;
begin
    result:=true;
    //---
...
procedure tTests_inkFIFO_20x4_EnumBreak._enumData_CLR(const DATA:pointer; str:NativeInt);
begin
    with pTests_EnumDATA(DATA)^ do begin
      owner  :=SELF;
      counter:=0;
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_Nil;
var lst:pointer;
    ddd:rTests_EnumDATA;
begin
   ...
   _enumData_CLR(@ddd,TST_STACK_Count);
    //--
    lst:=inkFIFO_nodesEnum(STACK,@ddd,@_Enum_FNK_);
    //--
    AssertNull  ('wrong enum stop', lst);
    AssertEquals('wrong enum nmbr', TST_STACK_Count,  DDD.counter);
end;

procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_One;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_Two_first;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_Two_last;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_SiX_first;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_SiX_middle;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
procedure tTests_inkFIFO_20x4_EnumBreak.Enumerate_SiX_last;
var lst:pointer;
    ddd:rTests_EnumDATA;
    bbb:integer;
begin
...
initialization
    RegisterTest(cTestSuitePath__inkFIFO,tTests_inkFIFO_20x4_EnumBreak);
end.
